...
set helplang=en
set lazyredraw
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/html5.vim,~/.vim/bundle/vim-multiple-cursors,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim74,/usr/local/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/html5.vim/after,~/.vim/bundle/vim-multiple-cursors/after
set shiftwidth=2
set showcmd
set smartindent
set softtabstop=2
...
silent only
cd ~/Public/hackdfw-site
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +68 index.html
badd +44 css/style.css
badd +0 js/javascript.js
argglobal
silent! argdel *
set stal=2
edit index.html
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 216 - ((27 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
216
